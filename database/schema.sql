...
CREATE TABLE ticket_events (
  ...
  actor_role     ENUM('employee','agent','admin') NOT NULL,
...
-- ============================================================================
-- TazamaDesk (TazamaITHelpDesk) — normalized SQL schema + seed data
-- Generated from data/seed.json (https://github.com/Moses798/TazamaITHelpDesk)
